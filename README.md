...
<h4> 1. export AWS_DEFAULT_REGION=us-east-1 </h4>   //set the region at Virginia. If you change this you have to change the ami in ~/pulumi-project/create-instance/index.ts
